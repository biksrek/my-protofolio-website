  ...
  return (
    <div className="min-h-screen bg-primary text-text font-sans selection:bg-accent selection:text-primary">
      ...
      <main>
        ...
        {/* Placeholders for other sections to verify layout */}
        <Services />
      ...
      <footer className="bg-secondary py-12 border-t border-slate-800">
        <div className="section-container py-0 flex flex-col items-center">
          <div className="flex space-x-6 mb-8">
            <a href="#" className="text-text-muted hover:text-accent transition-colors duration-300 transform hover:-translate-y-1">
            ...
            <a href="mailto:hello@bikkygupta.com" className="text-text-muted hover:text-accent transition-colors duration-300 transform hover:-translate-y-1">
          ...
          <p className="text-text-muted text-sm">
            &copy; {new Date().getFullYear()} Bikky Gupta. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
