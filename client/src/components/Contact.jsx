...
const Contact = () => {
    ...
    return (
        <Section id="contact" title="Get In Touch" subtitle="Whether you have a question or want to hire me, my inbox is always open.">
            <p className="text-center text-accent mb-8 font-medium animate-pulse">Available for freelance projects & full-time opportunities.</p>
            <div className="max-w-2xl mx-auto">
                <form onSubmit={handleSubmit} className="space-y-6 bg-secondary p-8 rounded-xl border border-slate-700">
                    ...
                    <div>
                        <label htmlFor="type" className="block text-sm font-medium text-text-muted mb-2">Inquiry Type</label>
                        <select
                            id="type"
                            name="type"
                            value={formData.type}
